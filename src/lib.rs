...
#[derive(Debug)]
pub struct VaultWeaverProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VaultWeaverProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VaultWeaver processing");
    
    let mut processor = VaultWeaverProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VaultWeaverProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VaultWeaverProcessor::new(false);
